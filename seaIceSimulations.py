...
# # # whole region for Alaska
# yStartWR = 155
# yEndWR = 448-198
# xStartWR = 60
# xEndWR = 304-125

# # whole region for Canada
yStartWR = 177
yEndWR = 448-175
xStartWR = 62
xEndWR = 304-123
...
# end = dt.datetime(2024,11,20)
end = dt.datetime(2024,12,15)
...
# bmus = bmus[6:-19]+1
# bmus_dates = iceDateTimes[6:-19]#[151:-214]

bmus = bmus[36:-15]+1
bmus_dates = iceDateTimes[36:-15]#[151:-214]
...
xds_Temp_fit = xr_daily(xds_Temp_fit, datetime(1978, 12, 1),datetime(2024,11,30))
...
for simIndex in range(diffSims):
    ...
    # # Save results for matlab plot
    # evbmus_sim[:,c:c+2] = xds_ALR.evbmus_sims.values
    # c = c + 2
    # Save results for matlab plot
...
# areaBelow2 = areaBelow[6:-19]
areaBelow2 = areaBelow[36:-15]
...
# multi-year
wavesYearly = np.nan*np.ones((45,365))
c = 61
ax2 = plt.subplot2grid((2,1),(1,0))
for hh in range(45):
...
samplesPickle = 'ice18FutureSimulations1000Tuk.pickle'
