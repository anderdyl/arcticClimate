...
# # video.release()
#
# allIce = np.ones((len(iceSubset),14300))
#
...
for ff in range(len(grabYears)):
    ...
    for hh in range(len(files)):
        ...
        iceSubset.append(iceMasked[150:235,55:150])
...
# allIce = np.ones((len(iceSubset),110*130))
allIce = np.ones((len(iceSubset),85*95))
...
while keep_iter:
    ...
    kma = KMeans(n_clusters=num_clusters, n_init=1000).fit(PCsub)
...
dwtPickle = 'iceData49SmallishClustersY2022.pickle'
outputDWTs = {}
