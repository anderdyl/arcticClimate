...
nome.tideoutDylan = download_noaa_tides_dylanWithPred('9468756', 'MSL', 1999, 2024);
red.tideoutDylan = download_noaa_tides_dylanWithPred('9491094', 'MSL', 2003, 2024);
pru.tideoutDylan = download_noaa_tides_dylanWithPred('9497645', 'MSL', 1990, 2024);
...
%%
matFileName = '/users/dylananderson/documents/data/chsWest/purdhoeBay/noaa9497645.mat';
ssoutdir = '/users/dylananderson/documents/data/chsWest/purdhoeBay/';
fname = 'purdhoeBay';
cd(ssoutdir)
dat = pru.tideoutDylan.wl;
time = pru.tideoutDylan.wltime;
time_tide = pru.tideoutDylan.predtime(1:10:end);
tide = pru.tideoutDylan.pred(1:10:end);
lin = 1;
%pth = '/volumes/Elements/downloaded_functions/TWLdecompositionCode/';
pth = '/users/dylananderson/documents/data/chsWest/TWLdecompositionCode/';
addpath(genpath(pth))
%[MSL,MMSL,MMSLA,MMSLA_hourly,DSLA,climatology,climatologyDaily,month_time,parameters] = splitNTR_v2(dat,time,lin,pth,fname);
...
%%
matFileName = '/users/dylananderson/documents/data/chsWest/nome/noaa9468756.mat';
ssoutdir = '/users/dylananderson/documents/data/chsWest/nome/';
fname = 'nome';
cd(ssoutdir)
dat = nome.tideoutDylan.wl;
time = nome.tideoutDylan.wltime;
time_tide = nome.tideoutDylan.predtime(1:10:end);
tide = nome.tideoutDylan.pred(1:10:end);
lin = 1;
%pth = '/volumes/Elements/downloaded_functions/TWLdecompositionCode/';
pth = '/users/dylananderson/documents/data/chsWest/TWLdecompositionCode/';
addpath(genpath(pth))
...
%%
matFileName = '/users/dylananderson/documents/data/chsWest/nome/noaa9491094.mat';
ssoutdir = '/users/dylananderson/documents/data/chsWest/redDog/';
fname = 'redDog';
cd(ssoutdir)
dat = red.tideoutDylan.wl;
time = red.tideoutDylan.wltime;
time_tide = red.tideoutDylan.predtime(1:10:end);
tide = red.tideoutDylan.pred(1:10:end);
lin = 1;
%pth = '/volumes/Elements/downloaded_functions/TWLdecompositionCode/';
pth = '/users/dylananderson/documents/data/chsWest/TWLdecompositionCode/';
addpath(genpath(pth))
