...
test3 = onlyIce[0,:]
# ice concentration ranges from 0-1, with several values over 1 dedicated to different classes
...
# spatialField = onlyIceLessLand[-10]#gapFilledIce[300]  # / 100 - np.nanmean(SLP_C, axis=0) / 100
...
#
#
# xPoints = np.asarray([x[64],x[72],x[74],x[77],x[77],x[78],x[74],x[71],x[68],x[67]])
# yPoints = np.asarray([y[267],y[263],y[260],y[254],y[249],y[244],y[240],y[235],y[230],y[225]])
#
# plt.plot(xPoints,yPoints,'ro')
#
#
# for hh in range(len(xPoints)):
#     xTemp = xPoints
#
#
